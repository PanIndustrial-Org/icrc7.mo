      ...
      case (?val) {
        {
          ...
          max_update_batch_size = switch (val.max_update_batch_size) {
            case (null) v0_2_0.default_max_update_batch_size;
            case (?val) val;
          };
          max_query_batch_size = switch (val.max_query_batch_size) {
            case (null) v0_2_0.default_max_query_batch_size;
            case (?val) val;
          };
          default_take_value = switch (val.default_take_value) {
            case (null) v0_2_0.default_default_take_value;
            case (?val) val;
          };
          max_take_value = switch (val.max_take_value) {
            case (null) v0_2_0.default_max_take_value;
            case (?val) val;
          };
          max_memo_size = switch (val.max_memo_size) {
            case (null) v0_2_0.default_max_memo_size;
            case (?val) val;
          };
          permitted_drift = switch (val.permitted_drift) {
            case (null) v0_2_0.default_permitted_drift;
            case (?val) val;
          };
          allow_transfers = switch (val.allow_transfers) {
            case (null) v0_2_0.default_allow_transfers;
            case (?val) val;
          };
      ...
      case (_) {
        {
          ...
          supply_cap = null;
          total_supply = 0;
          max_query_batch_size = v0_2_0.default_max_query_batch_size;
          max_update_batch_size = v0_2_0.default_max_update_batch_size;
          default_take_value = v0_2_0.default_default_take_value;
          max_take_value = v0_2_0.default_max_take_value;
          max_memo_size = v0_2_0.default_max_take_value;
          permitted_drift = v0_2_0.default_permitted_drift;
          allow_transfers = v0_2_0.default_allow_transfers;
          burn_account = null;
          deployer = owner;
        };
      };
